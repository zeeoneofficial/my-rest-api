    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api Reisuke - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6283825144098">WhatsApp</a></span></span>
            <span style="display: block;"><br>Akihiko,<br>Reisuke</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"Reisuke" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api Reisuke`,
        html: inboxGmail,
      };
